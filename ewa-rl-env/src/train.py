...
if __name__ == "__main__":
    ...
    np.save("../models/agent_action_space.npy",
        np.array(trained_agent.action_space, dtype=object))
    print("Agent's action space saved to '../models/agent_action_space.npy'")